(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue"), require("@element-plus/icons-vue"), require("element-plus")) : typeof define === "function" && define.amd ? define(["exports", "vue", "@element-plus/icons-vue", "element-plus"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.AhUI = {}, global.Vue, global.iconsVue, global.ElementPlus));
})(this, function(exports2, vue, iconsVue, elementPlus) {
  "use strict";
  ...
  const _hoisted_1$1 = { class: "ah-table-wrapper" };
  const _hoisted_2 = {
    key: 0,
    class: "ah-table-search"
  };
  const _hoisted_3 = {
    key: 1,
    class: "ah-table-action"
  };
  const _hoisted_4 = { class: "action-left" };
  const _hoisted_5 = { class: "action-right" };
  const _hoisted_6 = {
    key: 2,
    class: "ah-table-pagination"
  };
  const _sfc_main$e = /* @__PURE__ */ vue.defineComponent({
    ...
    emits: ["update:remoteParams", "selection-change", "search-change", "page-change", "sort-change", "export-success", "export-error"],
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const searchModel = vue.reactive({});
      const searchFormRef = vue.ref();
      const tableRef = vue.ref();
      const selectedRows = vue.ref([]);
      const showColumnDialog = vue.ref(false);
      ...
      vue.watch(
        ...
        (forms) => {
          if (forms) {
            forms.forEach((item) => {
              var _a;
              if (((_a = item.props) == null ? void 0 : _a.defaultValue) !== void 0) {
      ...
      const loadData = async (params) => {
        ...
        try {
          ...
          if (props.remotePaging) {
            tableData.value = ((_a = res.data) == null ? void 0 : _a.list) || ((_b = res.data) == null ? void 0 : _b.rows) || res.data || [];
            total.value = ((_c = res.data) == null ? void 0 : _c.total) || res.total || 0;
          } else {
            tableData.value = ((_d = res.data) == null ? void 0 : _d.list) || res.data || [];
            total.value = tableData.value.length;
          }
        } catch (error) {
      ...
      const handleReset = () => {
        var _a;
        (_a = searchFormRef.value) == null ? void 0 : _a.resetFields();
        handleSearch();
      };
      ...
      const handleApiExport = async () => {
        if (!props.exportApi) {
          elementPlus.ElMessage.warning("未配置导出接口 export-api");
          return;
        }
        loading.value = true;
        try {
          ...
          if (res instanceof Blob) {
            ...
            blob = res.data;
            fileName = res.filename || props.exportFileName;
          } else if (res.url || res.href) {
            const link2 = document.createElement("a");
            link2.href = res.url || res.href;
            ...
            elementPlus.ElMessage.error("接口返回格式不正确");
          ...
          link.href = url;
          link.download = `${fileName}_${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.xlsx`;
          link.click();
          URL.revokeObjectURL(url);
          elementPlus.ElMessage.success("导出成功");
          emit("export-success");
      ...
      const handleExport = () => {
        ...
        const colWidths = keys2.map((key) => ({
          wch: Math.max(...data.map((row) => String(row[key] || "").length), headers[key].length)
        }));
        worksheet["!cols"] = colWidths;
        const fileName = `${props.exportFileName}_${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}`;
      ...
      const getTableColumns = () => {
        var _a;
        const columns = [];
        const slots = ((_a = tableRef.value) == null ? void 0 : _a.$slots) || {};
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$1, [
          __props.showSearch && ((_a = __props.searchForm) == null ? void 0 : _a.length) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2, [
            vue.createVNode(_component_el_form, {
              ref_key: "searchFormRef",
              ref: searchFormRef,
              model: searchModel,
              inline: true,
              "label-width": __props.searchLabelWidth,
              class: "search-form",
              onSubmit: vue.withModifiers(handleSearch, ["prevent"])
            }, {
              default: vue.withCtx(() => [
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.searchForm, (item) => {
                  return vue.openBlock(), vue.createBlock(_component_el_form_item, {
                    ...
                    default: vue.withCtx(() => [
                      (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(getSearchComponent(item)), vue.mergeProps({
                        modelValue: searchModel[item.prop],
                        "onUpdate:modelValue": ($event) => searchModel[item.prop] = $event
                      }, { ref_for: true }, item.props, {
                        placeholder: item.placeholder || `请输入${item.label}`,
                        clearable: "",
                        onChange: ($event) => {
                          var _a2;
                          return (_a2 = item.change) == null ? void 0 : _a2.call(item, $event);
                        }
                      }), null, 16, ["modelValue", "onUpdate:modelValue", "placeholder", "onChange"]))
                    ]),
                    _: 2
                  }, 1032, ["label", "prop"]);
                }), 128)),
          ...
          __props.showActionBar ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3, [
            vue.createElementVNode("div", _hoisted_4, [
              vue.renderSlot(_ctx.$slots, "action-left", {}, void 0, true)
            ]),
            vue.createElementVNode("div", _hoisted_5, [
              vue.renderSlot(_ctx.$slots, "action-right", {}, void 0, true),
              __props.showExport ? (vue.openBlock(), vue.createBlock(_component_el_button, {
                key: 0,
              ...
              __props.showRefresh ? (vue.openBlock(), vue.createBlock(_component_el_button, {
                key: 1,
                icon: vue.unref(iconsVue.Refresh),
                circle: "",
                onClick: _cache[0] || (_cache[0] = ($event) => loadData())
              }, null, 8, ["icon"])) : vue.createCommentVNode("", true),
              __props.showColumnSetting ? (vue.openBlock(), vue.createBlock(_component_el_button, {
                key: 2,
                icon: vue.unref(iconsVue.Setting),
                circle: "",
                onClick: _cache[1] || (_cache[1] = ($event) => showColumnDialog.value = true)
              }, null, 8, ["icon"])) : vue.createCommentVNode("", true)
            ])
          ])) : vue.createCommentVNode("", true),
          vue.withDirectives((vue.openBlock(), vue.createBlock(_component_el_table, {
            ...
            default: vue.withCtx(() => [
              __props.showSelection ? (vue.openBlock(), vue.createBlock(_component_el_table_column, {
                key: 0,
                type: "selection",
                width: "55",
                align: "center"
              })) : vue.createCommentVNode("", true),
              __props.showIndex ? (vue.openBlock(), vue.createBlock(_component_el_table_column, {
                key: 1,
                type: "index",
                label: "序号",
                width: "60",
            ...
            _: 3
          }, 8, ["data", "border", "stripe", "height", "max-height", "row-key", "expand-row-keys"])), [
            [_directive_loading, loading.value]
          ]),
          __props.showPagination ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_6, [
          ...
          vue.createVNode(_component_el_dialog, {
            modelValue: showColumnDialog.value,
            "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => showColumnDialog.value = $event),
            title: "列设置",
            width: "400px"
          }, {
            footer: vue.withCtx(() => [
              vue.createVNode(_component_el_button, {
                onClick: _cache[5] || (_cache[5] = ($event) => showColumnDialog.value = false)
              }, {
            ...
            default: vue.withCtx(() => [
              vue.createVNode(_component_el_checkbox_group, {
                ...
                "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => visibleColumns.value = $event)
              }, {
                default: vue.withCtx(() => [
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(allColumns.value, (col) => {
  ...
  const AhTable = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-a0394000"]]);
  ...
  const _sfc_main$d = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_el_table_column, {
          ...
          _ctx.slot ? {
            ...
            fn: vue.withCtx((scope) => [
              vue.renderSlot(_ctx.$slots, _ctx.slot, {
                row: scope.row,
                $index: scope.$index
              })
            ]),
        ...
        ]), 1032, ["prop", "label", "width", "min-width", "fixed", "sortable", "show-overflow-tooltip", "align"]);
      };
    }
  });
  AhTable.install = (app) => {
    app.component("AhTable", AhTable);
    app.component("AhTableColumn", _sfc_main$d);
  };
  const _sfc_main$c = /* @__PURE__ */ vue.defineComponent({
    ...
    props: {
      ...
      gutter: { default: 20 },
      defaultSpan: { default: 8 },
      showActions: { type: Boolean, default: true },
      submitText: { default: "提交" },
      resetText: { default: "重置" }
    },
    emits: ["update:model", "submit", "reset", "change"],
    setup(__props, { expose: __expose, emit: __emit }) {
      const props = __props;
      const emit = __emit;
      ...
      vue.watch(
        ...
        (schemas) => {
          schemas.forEach((item) => {
            var _a;
            if (((_a = item.props) == null ? void 0 : _a.defaultValue) !== void 0 && model[item.prop] === void 0) {
      ...
      const loadOptions = async (item) => {
        ...
        if (item.api && !item.options) {
          try {
            ...
            item.options = res.data || ((_a = res.data) == null ? void 0 : _a.list) || ((_b = res.data) == null ? void 0 : _b.rows) || [];
          } catch (error) {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_el_form, {
          ...
          default: vue.withCtx(() => [
            vue.createVNode(_component_el_row, { gutter: __props.gutter }, {
              default: vue.withCtx(() => [
                    ...
                    default: vue.withCtx(() => [
                      vue.createVNode(_component_el_form_item, {
                        ...
                        default: vue.withCtx(() => {
                          var _a, _b;
                          return [
                            (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(getComponent(item.component)), vue.mergeProps({
                              modelValue: model[item.prop],
                              "onUpdate:modelValue": ($event) => model[item.prop] = $event
                            }, { ref_for: true }, item.props, {
                              placeholder: item.placeholder || `请输入${item.label}`,
                              ...
                              item.component === "select" && item.optionLabel ? {
                                name: "default",
                                fn: vue.withCtx(() => [
                              ...
                              ((_a = item.slots) == null ? void 0 : _a.prefix) ? {
                                name: "prefix",
                                fn: vue.withCtx(() => [
                                  vue.createTextVNode(vue.toDisplayString(item.slots.prefix), 1)
                                ]),
                                key: "1"
                              } : void 0,
                              ((_b = item.slots) == null ? void 0 : _b.suffix) ? {
                                name: "suffix",
                                fn: vue.withCtx(() => [
                                  vue.createTextVNode(vue.toDisplayString(item.slots.suffix), 1)
                                ]),
                                key: "2"
                              } : void 0
                            ]), 1040, ["modelValue", "onUpdate:modelValue", "placeholder", "disabled", "options", "api", "clearable", "onChange"]))
                          ];
                        }),
                        _: 2
                ...
                __props.showActions ? (vue.openBlock(), vue.createBlock(_component_el_col, {
                  key: 0,
                  span: __props.defaultSpan
                }, {
                  default: vue.withCtx(() => [
                    vue.createVNode(_component_el_form_item, null, {
                      default: vue.withCtx(() => [
                        ...
                        vue.createVNode(_component_el_button, { onClick: handleReset }, {
                          default: vue.withCtx(() => [
          ...
          _: 3
        }, 8, ["model", "rules", "label-width", "label-position", "inline", "size", "disabled"]);
      };
    }
  });
  ...
  const _sfc_main$a = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_el_input, vue.normalizeProps(vue.guardReactiveProps(_ctx.$attrs)), null, 16);
      };
    }
  });
  const _sfc_main$9 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_el_select, vue.mergeProps(_ctx.$attrs, { loading: loading.value }), {
          default: vue.withCtx(() => [
            vue.renderSlot(_ctx.$slots, "default", {}, () => [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.options, (item) => {
                return vue.openBlock(), vue.createBlock(_component_el_option, {
                  key: item[__props.optionValue],
                  label: item[__props.optionLabel],
                  value: item[__props.optionValue],
  ...
  const _sfc_main$8 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_el_date_picker, vue.mergeProps(_ctx.$attrs, { type: "date" }), null, 16);
      };
    }
  });
  const _sfc_main$7 = /* @__PURE__ */ vue.defineComponent({
    ...{
      name: "AhDateRangePicker"
    },
    __name: "AhDateRangePicker",
    setup(__props) {
      return (_ctx, _cache) => {
        const _component_el_date_picker = vue.resolveComponent("el-date-picker");
        return vue.openBlock(), vue.createBlock(_component_el_date_picker, vue.mergeProps(_ctx.$attrs, {
          type: "daterange",
          "range-separator": "至",
  ...
  const _sfc_main$6 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_el_time_picker, vue.normalizeProps(vue.guardReactiveProps(_ctx.$attrs)), null, 16);
      };
    }
  });
  const _sfc_main$5 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_el_switch, vue.normalizeProps(vue.guardReactiveProps(_ctx.$attrs)), null, 16);
      };
    }
  });
            ...
            vue.renderSlot(_ctx.$slots, "default", {}, () => [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.options, (item) => {
                return vue.openBlock(), vue.createBlock(_component_el_radio, {
                  ...
                  default: vue.withCtx(() => [
                    vue.createTextVNode(vue.toDisplayString(item[__props.optionLabel]), 1)
                  ]),
                  _: 2
                }, 1032, ["value"]);
              }), 128))
  ...
  const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
    ...
    __name: "AhInputNumber",
    setup(__props) {
      return (_ctx, _cache) => {
        const _component_el_input_number = vue.resolveComponent("el-input-number");
        return vue.openBlock(), vue.createBlock(_component_el_input_number, vue.normalizeProps(vue.guardReactiveProps(_ctx.$attrs)), null, 16);
      };
    }
  });
  const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_el_cascader, vue.normalizeProps(vue.guardReactiveProps(_ctx.$attrs)), null, 16);
      };
    }
  });
  const _hoisted_1 = {
  ...
  const _sfc_main = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_el_upload, vue.mergeProps(_ctx.$attrs, { "auto-upload": false }), {
          tip: vue.withCtx(() => [
            _ctx.$attrs.tip ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, vue.toDisplayString(_ctx.$attrs.tip), 1)) : vue.createCommentVNode("", true)
          ]),
          default: vue.withCtx(() => [
            vue.renderSlot(_ctx.$slots, "default", {}, () => [
              vue.createVNode(_component_el_button, { type: "primary" }, {
                default: vue.withCtx(() => [..._cache[0] || (_cache[0] = [
                  vue.createTextVNode("点击上传", -1)
                ])]),
                _: 1
              })
            ])
  ...
  const formComponents = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    AhCascader: _sfc_main$1,
    AhCheckbox: _sfc_main$3,
    AhDatePicker: _sfc_main$8,
    AhDateRangePicker: _sfc_main$7,
    AhInput: _sfc_main$a,
    AhInputNumber: _sfc_main$2,
    AhRadio: _sfc_main$4,
    AhSelect: _sfc_main$9,
    AhSwitch: _sfc_main$5,
    AhTimePicker: _sfc_main$6,
    AhUpload: _sfc_main
  }, Symbol.toStringTag, { value: "Module" }));
  const components = {
    AhForm: _sfc_main$c,
    AhFormItem: _sfc_main$b,
    ...formComponents
  };
  ...
  exports2.AhForm = _sfc_main$c;
  exports2.AhFormItem = _sfc_main$b;
  exports2.AhTable = AhTable;
  exports2.AhTableColumn = _sfc_main$d;
  exports2.formComponents = formComponents;
